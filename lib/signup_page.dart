...
class _SignupPageState extends State<SignupPage>{
  ...
  void signup() async{
    ...
    if(dob ==null){
      showMsg("select a date of birth");
      return;
    }
    if(!service.isAtLeast13(dob!)){
      showMsg("Must be at least 13 years old");
      return;
    }
    ...
    await service.signup(firstName: firstName.text, lastName: lastName.text, dob: dob!, email: email.text, password: password.text);
